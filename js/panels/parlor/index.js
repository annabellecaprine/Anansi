...
CRITICAL: Respond ONLY with valid JSON:
{
  ...
  // Helper functions (createActorFromParlor, createPairFromParlor) moved to parlor-preview.js
    ...
    async function startWeaving() {
      ...
      try {
        ...
        if (isEnsemble && cardData.characters) {
          ...
          setTimeout(() => A.Parlor.showEnsemblePreview(cardData, answers), 1000);
        } else {
          ...
          setTimeout(() => A.Parlor.showPreviewModal(cardData, answers), 1000);
        }
  ...
  // PREVIEW MODALS moved to js/plugins/parlor/parlor-preview.js
