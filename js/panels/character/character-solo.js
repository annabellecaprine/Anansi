        ...
        <div class="card mb-md">
          <div class="card-body p-sm">
            <div class="flex-row gap-sm">
              <button class="btn btn-primary flex-1" id="tab-solo">Solo Mode</button>
              <button class="btn btn-ghost flex-1" id="tab-ensemble">Ensemble Mode</button>
            </div>
          </div>
        </div>
          ...
          <div class="card mb-md">
            <div class="card-header flex-row justify-between items-center">
              ...
              <div class="flex-row gap-sm items-center">
                ...
                <span class="status-badge ${solo.overrides.personality.dirty ? 'edited' : 'synced'} text-tiny px-sm py-xs rounded-full" 
                      style="background:${solo.overrides.personality.dirty ? 'var(--status-warning)' : 'var(--status-success)'};color:white;">
          ...
          <div class="card mb-md">
            <div class="card-header flex-row justify-between items-center">
              ...
              <div class="flex-row gap-sm items-center">
                ...
                <span class="status-badge ${solo.overrides.scenario.dirty ? 'edited' : 'synced'} text-tiny px-sm py-xs rounded-full"
                      style="background:${solo.overrides.scenario.dirty ? 'var(--status-warning)' : 'var(--status-success)'};color:white;">
          ...
          <div class="card mb-md">
            <div class="card-header flex-row justify-between items-center">
              ...
              <div class="flex-row gap-sm items-center">
                ...
                <span class="status-badge ${solo.overrides.exampleDialogue.dirty ? 'edited' : 'synced'} text-tiny px-sm py-xs rounded-full"
                      style="background:${solo.overrides.exampleDialogue.dirty ? 'var(--status-warning)' : 'var(--status-success)'};color:white;">
            ...
            <div class="card-header flex-row justify-between items-center">
              ...
              <div class="flex-row gap-sm items-center">
                ...
                <span class="text-secondary text-sm">
                  ...
                  <span class="opacity-60 mr-xs">[${currentFmIndex + 1}/${fmOptions.length}]</span>
                </span>
                <button class="btn btn-ghost btn-sm" id="fm-next" ${currentFmIndex >= fmOptions.length - 1 ? 'disabled' : ''}>▶</button>
                <span class="status-badge ${solo.overrides.firstMessage.dirty ? 'edited' : 'synced'} text-tiny px-sm py-xs rounded-full"
                      style="background:${solo.overrides.firstMessage.dirty ? 'var(--status-warning)' : 'var(--status-success)'};color:white;">
